...
global y_behv = ""
	...
	esttab using "Results/New_Tex/rd_spending_equity_extra.tex", replace ///
    cells("b(fmt(3))") ///
    stats(CI Bandwidth N_eff ymean, labels( " " "Bandwidth" "N" "Mean Dep. Var.") fmt("%s" 3 0 3)) ///
    coeflabels(RD_Estimate "Estimate") ///
    plain noobs nostar nogap nonumbers nomtitles nolines ///
	...
	eststo clear 
	rd_tab, y("exp_total_per_stu") x("budget_hawk") yearcond("& year<=2017") noyearcond(1)
	
	esttab using "Results/New_Tex/rd_spending_budget.tex", replace ///
    cells("b(fmt(3))") ///
    stats(CI Bandwidth N_eff ymean, labels( " " "Bandwidth" "N" "Mean Dep. Var.") fmt("%s" 3 0 3)) ///
    coeflabels(RD_Estimate "Estimate") ///
    plain noobs nostar nogap nonumbers nomtitles nolines ///
	...
	eststo clear 
	rd_tab, y("exp_total_per_stu") x("equity_prior") yearcond("& year<=2017") noyearcond(1)
	
	esttab using "Results/New_Tex/rd_spending_equity.tex", replace ///
    cells("b(fmt(3))") ///
    stats(CI Bandwidth N_eff ymean, labels( " " "Bandwidth" "N" "Mean Dep. Var.") fmt("%s" 3 0 3)) ///
    coeflabels(RD_Estimate "Estimate") ///
    plain noobs nostar nogap nonumbers nomtitles nolines ///
	...
	eststo clear 
	rd_tab, y("ecd_test") x("equity_prior") noyearcond(1)
	
	esttab using "Results/New_Tex/rd_ecd_test_equity.tex", replace ///
    cells("b(fmt(3))") ///
    stats(CI Bandwidth N_eff ymean, labels( " " "Bandwidth" "N" "Mean Dep. Var.") fmt("%s" 3 0 3)) ///
    coeflabels(RD_Estimate "Estimate") ///
    plain noobs nostar nogap nonumbers nomtitles nolines ///
	...
	eststo clear 
	rd_tab, y("exp_total_per_stu") x("hisp") yearcond("& year<=2017") noyearcond(1)
	
	esttab using "Results/New_Tex/rd_spending_hisp.tex", replace ///
    cells("b(fmt(3))") ///
    stats(CI Bandwidth N_eff ymean, labels( " " "Bandwidth" "N" "Mean Dep. Var.") fmt("%s" 3 0 3)) ///
    coeflabels(RD_Estimate "Estimate") ///
    plain noobs nostar nogap nonumbers nomtitles nolines ///
