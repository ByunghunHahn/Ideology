...
capture mkdir "Results/New_Tex"

* Initialize texdoc
capture file close _all
texdoc init "Results/New_Tex/voting_analysis_table.tex", replace force
...
program define run_rd_analysis
    ...
    use "data_for_rd/with_missing/votes_`dataset'.dta" if dist_cnty~=1, clear
...
display "Voting analysis table written to Results/New_Tex/voting_analysis_table.tex"
...
capture file close _all
texdoc init "Results/New_Tex/voting_own_table.tex", replace force
...
display "Voting analysis table written to Results/New_Tex/voting_own_table.tex"
